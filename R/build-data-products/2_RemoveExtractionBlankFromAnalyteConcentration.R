...
analyte_concentration %>% 
  ...
  readr::write_excel_csv(
    paste0("data/processed/build-data-products/blank_filtered_analyte_concentration_",
           file_name,
           ".csv")
  ) %>% 
  arrow::write_parquet(
...
build_blank_filtered_analyte_concentration_table(extraction_blank_with_recovery,
                                                 analyte_concentration_with_recovery,
                                                 "with_recovery")

build_blank_filtered_analyte_concentration_table(extraction_blank_no_recovery,
