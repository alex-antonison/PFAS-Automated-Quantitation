...
limit_of_detection_concentration_ng = (peak area ratio - intercept)/slope

3. For instances where <LOQ, replace value with limit_of_detection_concentration_ng (for instnaces of not detected, set to 0.0)
