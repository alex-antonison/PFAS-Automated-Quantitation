...
5a. Need to include NF in analyte concentration calcualtions and add a "detection_flag" column that when NF, set to "Not Detected" and when not NF, set to "Detected" (Done)
