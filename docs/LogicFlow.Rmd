...
analyte_concentration_calculation_input -> step3
}")
```
...
2. Subtract the Extraction Blank from the Analyte Value
...
DiagrammeR::grViz("digraph {
  ...
  node [shape=none, margin=0]
    ...
    sourceSample [label = 'SetX_XXX_XXX_short.XLS', shape = folder, style = filled, fillcolor = linen]


    step1 [label = 'Filter to Extraction Blank values from Raw Source data using County column', shape = rectangle, style = filled, fillcolor = white]

        step2 [label = 'Set NF values to 0.0', shape = rectangle, style = filled, fillcolor = white]


    analyte_in_blank_sample [label=<
        <table border='0' cellborder='1' cellspacing='0' cellpadding='4'>
            <tr><td bgcolor='lightblue'>analyte_in_blank_sample</td></tr>
            // columns
            <tr><td align='left'>batch_number: numeric</td></tr>
            ...
            <tr><td align='left'>sample_mass_g: numeric</td></tr>
            <tr><td align='left'>individual_analyte_native_peak_area: numeric</td></tr>
        </table>
    >]
