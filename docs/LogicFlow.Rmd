...
DiagrammeR::grViz("digraph {
    ...
    internal_standard -> internal_standard_mix
    internal_standard_mix -> step2
...
DiagrammeR::grViz("digraph {
  ...
  peak_area_ratio [label=<
    ...
    analyte_limit_of_detection [label=<
        <table border='0' cellborder='1' cellspacing='0' cellpadding='4'>
            <tr><td bgcolor='lightblue'>analyte_limit_of_detection</td></tr>
            // columns
            <tr><td align='left'>individual_native_analyte_name: text</td></tr>
            <tr><td align='left'>limit_of_detection: text</td></tr>
        </table>
    >]
    ...
    analyte_concentration_calculation [label=<
        <table border='0' cellborder='1' cellspacing='0' cellpadding='4'>
            ...
            <tr><td align='left'>limit_of_detection: numeric</td></tr>
            <tr><td align='left'>minimum_average_peak_area_ratio: numeric</td></tr>
            <tr><td align='left'>maximum_average_peak_area_ratio: numeric</td></tr>
        </table>
    >]
...
3. Internal Standard Concentration ng/uL * 25', shape = rectangle, style = filled, fillcolor = white]
    ...
    analyte_limit_of_detection -> analyte_concentration_calculation [label = 'Add Limit of Detection for use when calculating Calibration_Curve_Range_Category']
...
analyte_limit_of_detection [label = 'Native_analyte_ISmatch_source.xlsx', shape = folder, fillcolor = linen]
...
analyte_limit_of_detection -> analyte_concentration_calculation_input
...
DiagrammeR::grViz("digraph {
    ...
    analyte_concentration_with_and_without_recovery [label=<
        <table border='0' cellborder='1' cellspacing='0' cellpadding='4'>
            <tr><td bgcolor='lightblue'>analyte_concentration_with_and_without_recovery</td></tr>
            // columns
            <tr><td align='left'>batch_number: text</td></tr>
            ...
            <tr><td align='left'>internal_standard_name: text</td></tr>
            <tr><td align='left'>internal_standard_detection_flag: text</td></tr>
            <tr><td align='left'>calibration_curve_range_category: text</td></tr>
            <tr><td align='left'>analyte_concentration_ng: text</td></tr>
        </table>
    >]
...
DiagrammeR::grViz("digraph {
  ...
  node [shape=none, margin=0]
    ...
    analyte_concentration_calculation_output [label = 'analyte_concentration_calculation_output', shape = folder, style = filled, fillcolor = lightblue]
    ...
    analyte_concentration_calculation_output -> step1
