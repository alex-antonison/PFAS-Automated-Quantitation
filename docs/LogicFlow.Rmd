...
analyte_reference_table -> calibration_curve_input
}")
```
...
step4 [label = 'Remove Calibration Levels below Limit of Quantitation (LOQ)']
...
step11 [label = 'Recovery >= 0.8 AND Recovery <= 1.2', shape = diamond]

step12 [label = 'Remove Calibration Levels with out of bounds Recovery Value']

calibration_curve_input -> step4 -> step6
step6 -> step7

step7 -> step9 [label = 'R^2 >= 0.99']
step7 -> step8  [label = 'R^2 < 0.99']
step9 -> step10 -> step11
step11 -> calibration_curve_output [label = 'Recovery Values in Bounds']
step11 -> step12 [label = 'Recovery Values out of Bounds']
step12 -> step6
step8 -> step6
