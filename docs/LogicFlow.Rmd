...
calibration_curve_recovery_output [label = 'calibration_curve_recovery_output', shape = folder, fillcolor = lightblue]

calibration_curve_r_squared_output [label = 'calibration_curve_r_squared_output', shape = folder, fillcolor = lightblue]
...
step7 -> calibration_curve_r_squared_output [label = 'R^2 >= 0.99']
calibration_curve_r_squared_output -> step9
step7 -> step8  [label = 'R^2 < 0.99']
step9 -> step10 -> step11
step11 -> calibration_curve_recovery_output [label = 'All Recovery Values in Bounds']
...
step62 -> calibration_curve_recovery_output
...
DiagrammeR::grViz("digraph {
  ...
  calibration_recovery_troubleshoot [label=<
    ...
    calibration_curve_output_with_recovery [label=<
        <table border='0' cellborder='1' cellspacing='0' cellpadding='4'>
            <tr><td bgcolor='lightblue'>calibration_curve_output_with_recovery</td></tr>
            // columns
            <tr><td align='left'>individual_native_analyte_name: text</td></tr>
    ...
    calibration_curve_output_no_recovery [label=<
        <table border='0' cellborder='1' cellspacing='0' cellpadding='4'>
            <tr><td bgcolor='lightblue'>calibration_curve_output_with_recovery</td></tr>
            // columns
            <tr><td align='left'>individual_native_analyte_name: text</td></tr>
...
#### Calculate Analyte Concentration without Recovery
...
calibration_curve_output [label = 'calibration_curve_output_no_recovery', shape = folder, fillcolor = lightblue]
...
#### Calculate Analyte Concentration with Recovery
...
// calcualted tables
peak_area_ratio [label = 'peak_area_ratio', shape = folder, fillcolor = lightblue]
calibration_curve_output [label = 'calibration_curve_output_with_recovery', shape = folder, fillcolor = lightblue]
