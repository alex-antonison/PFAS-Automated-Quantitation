...
step62 [label = 'Calculate slope of the cal curve:
y-axis = Average Peak Area Ratio
x-axis = Analyte Concentration Ratio']
...
step9 -> step10 -> step11
step11 -> calibration_curve_output [label = 'All Recovery Values in Bounds']
...
Area Ratio < Calibration Curve Minimum Average Peak Area Ratio = <LOQ (set Concentration Value to NaN)
Area Ratio > Calibration Curve Maximum Average Peak Area Ratio = Above Cal
Area Ratio within bounds = Within Calibration Range
']

step5 [label = 'Is Average Peak Area Ratio above or below LOQ?', shape = diamond]

step6 [label = 'Set Analyte Concentration to NaN']
...
step4 -> step5
step5 -> step6 [label = 'Average Peak Area Ratio below LOQ']
step5 -> step3 [label = 'Average Peak Area Ratio Abvoe LOQ']
}")
```
